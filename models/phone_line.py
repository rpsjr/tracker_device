...
class PhoneLine(models.Model):
    ...
    tel_operator = fields.Selection(
        [("claro", "Claro"), ("oi", "Oi"), ("tim", "Tim"), ("vivo", "Vivo")],
        "Network Provider",
        help="Network Telephone Provider",
    )
    phone_nr = fields.Char("Line Number", required=True)
    sim_card_serial = fields.Char(
        "Sim Card Serial", required=True, help="Sim Card Serial used in Bar Code"
    )
